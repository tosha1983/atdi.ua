...
{
    public class SimpleUsingWebQuery
    {
        public static void Run()
        {
            // Аудентификаици пользователя сервиса
            var authManager = GetAuthenticationManager("TcpAuthenticationManager");

            var credential = new UserCredential
            {
                UserName = "SomePortalUser",
                Password = "P@ssw0rd"
            };
            ...
            var webQueryService = GetWebQuery("PipeWebQuery"); // тип конечно точки зависит от конфигурации сервреа приложений
