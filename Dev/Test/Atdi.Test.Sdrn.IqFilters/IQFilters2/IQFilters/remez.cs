...
namespace IQFilters
{
    class remezAlgorithm
    {
         ...
         *********************/
        private static void freqSample(double[] A, bool is_symm, int N, float[] h)
        {
            double x, val;
            double M = (N - 1.0) / 2.0;
            if (is_symm)
         ...
         ********************/
        private static void remez(int numtaps, double[] bands, double[] des, double[] weight, int type, float[] h)
        {
