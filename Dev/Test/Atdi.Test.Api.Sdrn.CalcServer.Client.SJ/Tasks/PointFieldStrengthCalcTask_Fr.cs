...
{
    public static class PointFieldStrengthCalcTaskFrance
    {
        private static readonly string OwnerInstance = "Atdi.Test.Api.Sdrn.CalcServer.Client";
        private static readonly Guid OwnerProjectId = Guid.Parse("76DC5259-2348-4420-81AF-06C8CC779E6B");
        private static readonly Guid OwnerMapId = Guid.Parse("C8D52717-7576-42F7-80E9-E04B9E740347");
        //private static readonly string MainProjectMap = "Lviv";
        private static readonly string MainProjectMap = "FRplus1000k_400";
        ...
        //////////small
        //// 29-30 
        private static double[] sitesLatitudes = new double[] { 43.274721 };
        private static double[] sitesLongitudes = new double[] { 5.308333 };
        private static double[] sitesHeights = new double[] { 340 };

        private static double[] pointsLatitudes = new double[] { 39.613754 };
        private static double[] pointsLongitudes = new double[] { 9.157578 };
        ...
        public static void Run(WebApiDataLayer dataLayer, IQueryExecutor executor)
        {
            ...
            try
            {
                ...
                // определяем карту
                var mapId = 3;// DefineMap(dataLayer, executor, projectId);
        ...
        private static long DefineProject(WebApiDataLayer dataLayer, IQueryExecutor executor)
        {
            ...
            if (projectId == 0)
            {
                var insQuery = dataLayer.GetBuilder<IProject>()
                    ...
                    .SetValue(c => c.Projection, "EPSG3035")
                    .SetValue(c => c.Note,
