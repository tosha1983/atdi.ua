...
namespace Atdi.Test.Api.Sdrn.CalcServer.Client.Tasks
{
	public static class PointFieldStrengthCalcTask
	{
		...
		private static readonly Guid OwnerProjectId = Guid.Parse("d61ff53f-b655-4d28-8eff-b93f8ed2ee2f");
		...
		public static void Run(WebApiDataLayer dataLayer, IQueryExecutor executor)
		{
			try
			{
				...
				for (int i = 0; i < stations.Length; i++)
				{
					...
					var calcTaskId = CreateCalcTask(dataLayer, executor, clientContextId, stationId);
		...
		private static long CreateCalcTask(WebApiDataLayer dataLayer, IQueryExecutor executor, long contextId, long stationId)
		{
			var rand = new Random();
