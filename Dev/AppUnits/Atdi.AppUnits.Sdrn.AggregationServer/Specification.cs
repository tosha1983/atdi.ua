...
namespace Atdi.AppUnits.Sdrn.AggregationServer
{
    ...
    {
        public static readonly EventContext ThisComponent = "SDRN.AggregationServer";

    }

    static class Categories
    {
        public static readonly EventCategory Activating = "Activating";
    ...
    static class Events
    {
        public static readonly EventText HandlerTypesWereRegistered = "The DataBus Message Handler Types were registered";
        public static readonly EventText DispatcherWasActivated = "The DataBus Dispatcher was activated";
