...
{
    public class RegisterSensorHandler2 : ISdrnMessageHandler<MSG.Device.RegisterSensorMessage,  Atdi.Contracts.Sdrn.Server. Sensor>
    {
        ...
        public RegisterSensorHandler2(ISdrnMessagePublisher messagePublisher, IDataLayer<EntityDataOrm> dataLayer, ISdrnServerEnvironment environment, IEventEmitter eventEmitter, ILogger logger)
        {
