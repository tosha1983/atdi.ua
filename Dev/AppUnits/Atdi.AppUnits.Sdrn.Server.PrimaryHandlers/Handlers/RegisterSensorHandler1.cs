...
{
    public class RegisterSensorHandler1 : ISdrnMessageHandler<MSG.Device.RegisterSensorMessage, Sensor>
    {
        ...
        public RegisterSensorHandler1(ISdrnMessagePublisher messagePublisher, IDataLayer<EntityDataOrm> dataLayer, ISdrnServerEnvironment environment, IEventEmitter eventEmitter, ILogger logger)
        {
