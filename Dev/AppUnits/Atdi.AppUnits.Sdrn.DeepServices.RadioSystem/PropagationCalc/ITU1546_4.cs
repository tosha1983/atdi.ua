    ...
    public class ITU1546_4
    {
        ...
        private double Get_land_100m_50t(double h, double d)
        {
            ...
            if (h < 10)
            {
                ...
                if (h < 0)
                {
                    teta_eff = 180 * Math.Atan(-h / 9000) / Math.PI;
                }
                double Kv = 1.35;
                double v;
                v = Kv * teta_eff;
            ...
            {
                double Einf, Esup;
                Einf = Get_land_100m_50t_10h(d);
                Esup = Get_land_100m_50t_20h(d);
        ...
        private double Get_land_100m_10t(double h, double d)
        {
            double E = -9999;
            if (h < 10)
            {
        ...
        private double Get_land_2000m_10t(double h, double d)
        {
            double E = -9999;
            if (h < 10)
            {
        ...
        private double Get_land_50t(double h, double d, double f)
        {
            ...
            {
                double Einf, Esup;
                Einf = Get_land_100m_50t(h, d);
                Esup = Get_land_600m_50t(h, d);
                E = Einf + (Esup - Einf) * Math.Log10(f / 100) / Math.Log10(600 / 100);
                return E;
            }
            double Einf_, Esup_;
            Einf_ = Get_land_600m_50t(h, d);
            Esup_ = Get_land_2000m_50t(h, d);
        ...
        private double Get_land_10t(double h, double d, double f)
        {
            ...
            {
                double Einf, Esup;
                Einf = Get_land_100m_10t(h, d);
                Esup = Get_land_600m_10t(h, d);
                E = Einf + (Esup - Einf) * Math.Log10(f / 100) / Math.Log10(600 / 100);
                return E;
            }
            double Einf_, Esup_;
            Einf_ = Get_land_600m_10t(h, d);
            Esup_ = Get_land_2000m_10t(h, d);
            E = Einf_ + (Esup_ - Einf_) * Math.Log10(f / 600) / Math.Log10(2000.0 / 600);
            return E;
        }
        private double Get_land_1t(double h, double d, double f)
        {
            ...
            {
                double Einf, Esup;
                Einf = Get_land_100m_1t(h, d);
                Esup = Get_land_600m_1t(h, d);
                E = Einf + (Esup - Einf) * Math.Log10(f / 100) / Math.Log10(600 / 100);
                return E;
            }
            double Einf_, Esup_;
            Einf_ = Get_land_600m_1t(h, d);
            Esup_ = Get_land_2000m_1t(h, d);
            E = Einf_ + (Esup_ - Einf_) * Math.Log10(f / 600) / Math.Log10(2000.0 / 600);
            return E;
        }
        ...
        public static double Get_E(double ha, double hef, double d, double f, double p, double h_gr, double h2, params LandSea[] list1)
