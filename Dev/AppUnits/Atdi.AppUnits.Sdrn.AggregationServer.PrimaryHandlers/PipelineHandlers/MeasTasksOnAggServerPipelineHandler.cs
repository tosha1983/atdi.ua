...
{
    public class MeasTasksOnAggServerPipelineHandler : IPipelineHandler<ClientMeasTaskPipebox, ClientMeasTaskPiperesult>
    {
        ...
        public MeasTasksOnAggServerPipelineHandler(IDataLayer<EntityDataOrm> dataLayer, ILogger logger)
        {
        ...
        {
            using (this._logger.StartTrace(Contexts.ThisComponent, Categories.MeasTasksOnAggServerPipelineHandler, this))
            {
