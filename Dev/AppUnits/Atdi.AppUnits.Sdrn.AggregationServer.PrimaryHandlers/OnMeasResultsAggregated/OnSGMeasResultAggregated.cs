...
namespace Atdi.AppUnits.Sdrn.AggregationServer.PrimaryHandlers
{
    ...
    public class OnSGMeasResultAggregated
    {
        ...
        public OnSGMeasResultAggregated(IEventEmitter eventEmitter, IDataLayer<EntityDataOrm> dataLayer, ILogger logger, ISdrnServerEnvironment environment)
        {
            this._logger = logger;
