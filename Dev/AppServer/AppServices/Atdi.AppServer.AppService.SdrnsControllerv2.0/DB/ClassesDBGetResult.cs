                                ...
                                if (obj != null)
                                {
                                    ...
                                    if ((taskId != null) && (obj.StationMeasurements != null) && (obj.Id.SubMeasTaskId != Constants.NullI) && (obj.Id.SubMeasTaskStationId != Constants.NullI))
                                    {
                                        ...
                                        if (obj.StationMeasurements.StationId != null)
                                        {
                                            ...
                                            measRes.Close();
                                            measRes.Dispose();
                                            logger.Trace("[SaveResultToDB] - Create new record for table 'XbsResMeas'");
                                        }
                                    }
                                    if (ID != Constants.NullI)
                                    {
                                        ...
                                        if (api2Result.Routes != null)
                                        {
                                            ...
                                            logger.Trace("[SaveResultToDB] - Create new records for blocks 'api2Result.Routes'");
                                        }
                                        ...
                                        if (obj.ResultsMeasStation != null)
                                        {
                                            ...
                                            logger.Trace("[SaveResultToDB] - Create new records for blocks 'obj.ResultsMeasStation'");
                                        }
                                        ...
                                        if (obj.LocationSensorMeasurement != null)
                                        {
                                            ...
                                            logger.Trace("[SaveResultToDB] - Create new records for blocks 'obj.LocationSensorMeasurement '");
                                        }
                                        ...
                                        if (obj.MeasurementsResults != null)
                                        {
                                            ...
                                            logger.Trace("[SaveResultToDB] - Create new records for blocks 'obj.MeasurementsResults '");
                                        }
                                        if (BlockInsert_YXbsLevelmeasres1.Count > 0)
                                        {
                                            ...
                                            logger.Trace("[SaveResultToDB] - Create new records for table 'YXbsResLevels'");
                                        }
                                    }
                                }
                                transaction.Commit();
