...
namespace Atdi.AppServer.AppService.SdrnsControllerv2_0
{
    ...
    /// 
    /// </summary>
    public class ClassConvertTasks 
    {
        ...
        public MeasTask[] ConvertTo_MEAS_TASKObjects(List<ClassTasks> objs)
        {
            ...
            try
            {
                ...
                foreach (ClassTasks obj in objs.ToArray())
                {
        ...
        public MeasTask[] ConvertToShortMeasTasks(List<ClassTasks> objs)
        {
            List<MeasTask> L_OUT = new List<MeasTask>();
            try
            {
