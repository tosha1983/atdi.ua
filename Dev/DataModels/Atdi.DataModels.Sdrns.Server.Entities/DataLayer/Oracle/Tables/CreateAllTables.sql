...
CREATE SEQUENCE ICSC.MEAS_SUB_TASK_ID_SEQ
  START WITH 1
  MAXVALUE 9999999999999999999999999999
  MINVALUE 0
  NOCYCLE
...
CREATE SEQUENCE ICSC.MEAS_SUB_TASK_STATION_ID_SEQ
  START WITH 1
  MAXVALUE 9999999999999999999999999999
  MINVALUE 0
  NOCYCLE
...
CREATE TABLE ICSC.MEAS_SUBTASK_STATION
(
  ID               NUMBER(15)                   NOT NULL,
  STATUS           NVARCHAR2(50),
  COUNT            NUMBER(9),
  TIME_NEXT_TASK   DATE,
  SENSOR_ID        NUMBER(15),
  MEAS_SUBTASK_ID  NUMBER(15)                   NOT NULL
)
TABLESPACE USERS
PCTUSED    0
PCTFREE    10
...
CREATE UNIQUE INDEX ICSC.MEAS_SUB_TASK_STA_ID_PK ON ICSC.MEAS_SUBTASK_STATION
(ID)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
CREATE INDEX ICSC.RES_MEAS_STATION_IDSTATION_PK ON ICSC.RES_MEAS_STATION
(IDSTATION)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
CREATE INDEX ICSC.RES_MEAS_STATION_STATION_ID_PK ON ICSC.RES_MEAS_STATION
(STATION_ID)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
CREATE INDEX ICSC.RES_MEAS_STATION_SECTORID_PK ON ICSC.RES_MEAS_STATION
(SECTOR_ID)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
SELECT   DISTINCT Tcaz_1.LON AS LON,
                     ...
                     Tcaz_4.BW AS BW,
                     Tcaz_2.STATION_ID AS IDSTATION,
...
BEGIN
  ...
  ( job       => X 
   ...
   ,next_date => to_date('08.07.2019 16:41:28','dd/mm/yyyy hh24:mi:ss')
...
ALTER TABLE ICSC.MEAS_SUBTASK_STATION ADD (
