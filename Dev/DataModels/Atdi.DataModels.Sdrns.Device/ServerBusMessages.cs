...
namespace Atdi.DataModels.Sdrns.BusMessages
{
    namespace Server
    {
        ...
        public class InitOnlineMeasurementMessage : SdrnBusMessageType<InitOnlineMeasurementOptions>
        {
            public InitOnlineMeasurementMessage()
                : base("InitOnlineMeasurement")
            {
            }
        }
    }
