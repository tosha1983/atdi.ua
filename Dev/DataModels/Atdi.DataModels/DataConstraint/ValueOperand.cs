...
namespace Atdi.DataModels.DataConstraint
{
    ...
    public class ValueOperand : Operand
    {
        ...
        {
            return $"Type = '{Type}', DateType = '{DataType}'";
        }
        ...
        public static ValueOperand Create(DataType dataType, object value)
        {
            switch (dataType)
            {
                ...
                case DataType.Guid:
                    ...
                    if (value is string valGuidString)
                    {
                        return new GuidValueOperand
                        {
                            Value = new Guid(valGuidString)
                        };
                    }
                    return new GuidValueOperand
                    {
                ...
                case DataType.DateTimeOffset:
                    ...
                    if (value is DateTimeOffset valDT)
                    {
                        return new DateTimeOffsetValueOperand
                        {
                            Value = valDT
                    ...
                    if (value is string valDTString)
                    {
                        return new DateTimeOffsetValueOperand
                        {
        ...
        public static ValueOperand CreateBy(object value)
        {
