...
CREATE UNIQUE INDEX CALC.CLIENT_CONTEXTS_CLUTTER_PK ON CALC.CLIENT_CONTEXTS_CLUTTER
(CONTEXT_ID)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
ALTER TABLE CALC.CLIENT_CONTEXTS_CLUTTER ADD (
  CONSTRAINT CLIENT_CONTEXTS_CLUTTER_PK
 PRIMARY KEY
 (CONTEXT_ID)
    USING INDEX 
    TABLESPACE USERS
