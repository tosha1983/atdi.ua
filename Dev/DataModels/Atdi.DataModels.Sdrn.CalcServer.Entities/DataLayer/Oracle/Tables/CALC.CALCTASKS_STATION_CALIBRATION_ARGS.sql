...
CREATE UNIQUE INDEX CALC.PK_CALCTASKS_POINTFIELDSTRENGTH_ARGS_NEW ON CALC.CALCTASKS_STATION_CALIBRATION_ARGS
(TASK_ID)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
ALTER TABLE CALC.CALCTASKS_STATION_CALIBRATION_ARGS ADD (
  CONSTRAINT PK_CALCTASKS_STATION_CALIBRATION_ARGS_NEW_
 PRIMARY KEY
 (TASK_ID));
