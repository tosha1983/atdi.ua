...
CREATE UNIQUE INDEX CALC.PK_CLIENT_CONTEXTS_TROPO ON CALC.CLIENT_CONTEXTS_TROPO
(CONTEXT_ID)
LOGGING
TABLESPACE USERS
PCTFREE    10
...
ALTER TABLE CALC.CLIENT_CONTEXTS_TROPO ADD (
  CONSTRAINT PK_CLIENT_CONTEXTS_TROPO
 PRIMARY KEY
 (CONTEXT_ID));
