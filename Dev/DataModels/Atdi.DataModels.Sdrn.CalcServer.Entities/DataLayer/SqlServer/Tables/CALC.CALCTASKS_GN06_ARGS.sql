...
CREATE TABLE [CALC].[CALCTASKS_GN06_ARGS](
	...
	[CALCULATION_TYPE] [nvarchar](50) NULL,
	[SOURCE_BROADCASTING] [nvarchar](25) NULL,
	[BROADCASTING_ASSIGNMENTS] [varbinary](max) NULL,
	[BROADCASTING_ALLOTMENTS] [varbinary](max) NULL,
