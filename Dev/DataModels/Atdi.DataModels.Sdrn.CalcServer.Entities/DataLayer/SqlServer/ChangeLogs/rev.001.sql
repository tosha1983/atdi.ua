...
ALTER TABLE [CALC].[REF_SPECTRUM_BY_DRIVE_TESTS_ARGS_DEF] ADD  [SENSOR_IDS] [varbinary](max) NULL
GO


ALTER TABLE [CALC].[REF_SPECTRUM_BY_DRIVE_TESTS_ARGS] ADD  [SENSOR_IDS] [varbinary](max) NULL
GO
