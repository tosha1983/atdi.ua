...
namespace Atdi.Common
{
    public static class BandWidthEstimation
    {
        ...
        static public void GetBandwidthPoint(
            out int? prmT1,
            out int? prmT2,
            out int? prmMarkerIndex,
            out double? prmBandwidthkHz,
            out bool? prmСorrectnessEstimations,
            float[] SpecrtumArrdBm, BandwidthEstimationType bandwidthEstimationType = BandwidthEstimationType.beta, double X_Beta = 1, int MaximumIgnorPoint = 1)
        {
            ...
            prmBandwidthkHz = null;
            prmT1 = T1;
            prmT2 = T2;
            prmMarkerIndex = M1;
            prmСorrectnessEstimations = CorrectEstimation;
        }
