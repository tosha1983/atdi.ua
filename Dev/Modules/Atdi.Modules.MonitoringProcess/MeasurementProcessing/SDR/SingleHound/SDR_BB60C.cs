...
using NLog;
using Atdi.SDR.Server.Bus.Classes;
...
namespace Atdi.SDR.Server.MeasurementProcessing.SingleHound
{
    ...
    public partial class SDR_BB60C
    {
        ...
        public bool initiation_SDR()
        {
            ...
            catch (Exception ex) { GlobalInit.log.Trace("initiation_SDR:" + ex.Message); }
            return done;
        }
        /// <summary>
        /// Калибровка сенсора
        ...
        public bool calibration()
        {
            ...
            catch (Exception ex) { GlobalInit.log.Trace("calibration:" + ex.Message); }
            return done;
        }
        public void Close_dev()
        {
            ...
            catch (Exception ex) { GlobalInit.log.Trace("Close_dev" + ex.Message); }
        }
        ...
        public bool PutConfiguration(ref SDRParameters sDRParameters)
        {
            ...
            catch (Exception ex) { GlobalInit.log.Trace("PutConfiguration" + ex.Message); }
            return done;
        }
        /// <summary>
        ...
        private void put_config_for_sweep()
        {
            ...
            catch (Exception ex) { GlobalInit.log.Trace("put_config_for_sweep" + ex.Message); }
        }
        /// <summary>
        ...
        private void put_config_for_RT()
        {
            ...
            catch (Exception ex) { GlobalInit.log.Trace("put_config_for_RT" + ex.Message); }
        }
        #endregion
        ...
        private void Real_time(int n_RT)
        {
            ...
            catch (Exception ex) { GlobalInit.log.Trace("Real_time" + ex.Message); }
        }
        ...
        private void Sweep(int n_sweep)
        {
            ...
            catch (Exception ex) { GlobalInit.log.Trace("Sweep" + ex.Message); }
        ...
        public void CalcFsFormLevel(ref List<FSemples> F_Sem, Sensor sensor = null)
        {
            ...
            catch (Exception ex) { GlobalInit.log.Trace("calc_FS" + ex.Message); }
            return;
        }
        /// <summary>
        ...
        private void GetLevel()
        {
            ...
            catch (Exception ex) { GlobalInit.log.Trace("GetLevel" + ex.Message); }
            return;
        }
        #endregion
        ...
        private void MeasSO(ref MeasSdrTask taskSDR, Atdi.AppServer.Contracts.Sdrns.Sensor sensor = null, MeasSdrResults LastSDRresult = null)
        {
            ...
            catch (Exception ex) { GlobalInit.log.Trace("MeasSO" + ex.Message); }
        }
        #endregion
        ...
        private void MeasScan(Atdi.AppServer.Contracts.Sdrns.Sensor sensor = null, MeasSdrResults LastSDRresult = null)
        {
            ...
            catch (Exception ex) { GlobalInit.log.Trace("MeasScan" + ex.Message); }
        }
        /// <summary>
        ...
        private void MeasScanOnline(Atdi.AppServer.Contracts.Sdrns.Sensor sensor = null, MeasSdrResults LastSDRresult = null)
        {
            ...
            catch (Exception ex) { GlobalInit.log.Trace("MeasScanOnline" + ex.Message); }
        }
        #endregion
        ...
        private void MeasBW(ref MeasSdrTask taskSDR, Atdi.AppServer.Contracts.Sdrns.Sensor sensor = null, MeasSdrResults LastSDRresult = null)
        {
            ...
            catch (Exception ex) { GlobalInit.log.Trace("MeasBW" + ex.Message); }
        }
        #endregion
