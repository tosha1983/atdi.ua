...
namespace Atdi.Modules.MonitoringProcess.ProcessSignal
{
    static class BandwidthEstimation
    {
        ...
        static private void GetBandwidthPointMethodXFromTheCenter(ref double[] SpecrtumArrdBm, int M1, double TrigerLevelmW, int MaximumIgnorPoint, out int T1, out int T2)
        {
        ...
        static private void GetBandwidthPointMethodXFromTheEdge(ref double[] SpecrtumArrdBm, int M1, double TrigerLeveldBm, int MaximumIgnorPoint, out int T1, out int T2)
        {
            T1 = 0; T2 = SpecrtumArrdBm.Length - 1;
        ...
        static private void MoveInArr(ref double[] SpecrtumArrdBm, double TrigerLeveldBm, int from, int to, int MaximumIgnorPoint, bool downTrigLevel, out int point)
        ...
        static private bool CheckCorrectionInputSignalForBandwidthEstimation(ref double[] SpecrtumArrdBm, int MaximumIgnorPoint, double LevelOfSuspiciousJumpdB, out double SumPow, out int imax)
        {
            // constant 
        ...
        static private void CalcSumAndMaxFromArry(ref double[] SpecrtumArrdBm, int MaximumIgnorPoint, double LevelOfSuspiciousJumpdB, out double SumPow, out int imax)
