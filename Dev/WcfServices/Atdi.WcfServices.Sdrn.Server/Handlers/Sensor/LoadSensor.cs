...
namespace Atdi.WcfServices.Sdrn.Server
{
    public class LoadSensor
    {
        ...
        public LoadSensor(ISdrnServerEnvironment environment, ISdrnMessagePublisher messagePublisher, IEventEmitter eventEmitter, IDataLayer<EntityDataOrm> dataLayer, ILogger logger)
        {
        ...
        public Sensor LoadObjectSensor(int id)
        {
                    ...
                    while (reader.Read())
                    {
                        ...
                        queryExecuter.Fetch(builderSelectSensorAntenna, readerSensorAntenna =>
                        {
                            ...
                            while (readerSensorAntenna.Read())
                            {
                                ...
                                if (custData1 != null) val.Antenna.CustData1 = custData1.ToShortDateString();
                                ...
                                {
                                    var resultAntennaPattern = false;
                                    while (readerIAntennaPattern.Read())
                                    {
                                        AntennaPattern patt = new AntennaPattern();
                                    ...
                                    return resultAntennaPattern;
                                });
                                val.Antenna.AntennaPatterns = antennaPattern.ToArray();

                            }
                            return resultSensorAntenna;
                        });
                        ...
                        queryExecuter.Fetch(builderSelectEquipment, readerEquipment =>
                        {
                            ...
                            while (readerEquipment.Read())
                            {
                                ...
                                {
                                    var resultreaderSensorSensitivites = false;
                                    while (readerSensorSensitivites.Read())
                                    {
                                        SensorEquipSensitivity sens = new SensorEquipSensitivity();
                                    ...
                                    return resultreaderSensorSensitivites;
                                });
                        ...
                        {
                            var resultsensorLocation = false;
                        ...
                        {
                            var resultsensorPolygonPoin = false;
                            ...
                            return resultsensorPolygonPoin;
                        });
            ...
            {
                // _logger.Error("Error in procedure LoadObjectAllSensor: " + ex.Message);
            }
            return val;
        }
    }
