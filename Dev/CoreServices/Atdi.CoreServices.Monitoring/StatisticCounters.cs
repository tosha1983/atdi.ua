...
{
    class StatisticCounters : IStatisticCounters
    {
        private readonly StatisticCollector _collector;
        private readonly ILogger _logger;

        public StatisticCounters(StatisticCollector collector, ILogger logger)
        {
        ...
        {
            var counters = _collector.GetCounterRecords();
