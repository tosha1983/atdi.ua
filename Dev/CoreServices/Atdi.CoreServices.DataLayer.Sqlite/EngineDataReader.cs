...
namespace Atdi.CoreServices.DataLayer.Sqlite
{
    class EngineDataReader : IEngineDataReader
    {
        ...
        public EngineDataReader(SqliteDataReader reader, Mapper mapper)
        {
            this._reader = reader;
            this._mapper = mapper;
        }
        ...
        private static byte[] ReadBytes(SqliteDataReader dataReader, int ordinal)
        {
        ...
        public XmlReader GetXmlReader(int i)
        {
			...
			throw new InvalidOperationException(Exceptions.NotSupportedMethod.With(nameof(GetXmlReader)));
		}
        ...
        {
            return $"Fields = {_reader.FieldCount}, RowsAffected = {_reader.RecordsAffected}, HasRows = {_reader.HasRows}";
        }
