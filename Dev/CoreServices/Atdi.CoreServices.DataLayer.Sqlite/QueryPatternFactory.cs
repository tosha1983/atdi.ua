...
namespace Atdi.CoreServices.DataLayer.Sqlite
{
    internal sealed class QueryPatternFactory : LoggedObject
    {
        ...
        public QueryPatternFactory(ILogger logger) : base(logger)
        {
            ...
            logger.Verbouse(Contexts.SqliteEngine, Categories.Creation, Events.ObjectWasCreated.With("QueryPatternFactory"));
        }
        ...
        private void FindHandlersInCurrentAssembly()
        {
            ...
            _handlers.Add(typeof(PS.UpdatePattern), new PatternHandlers.UpdatePatternHandler(this.Logger));
            _handlers.Add(typeof(PS.DeletePattern), new PatternHandlers.DeletePatternHandler(this.Logger));
        }
