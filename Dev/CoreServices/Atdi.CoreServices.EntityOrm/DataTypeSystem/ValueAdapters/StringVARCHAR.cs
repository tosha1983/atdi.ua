...
{
    class StringVARCHAR : ValueAdapter<string, string>
    {
        public StringVARCHAR(IDataTypeMetadata dataTypeMetadata, ILogger logger) : base(dataTypeMetadata, logger)
        {
        }
        ...
        {
            return ValueReader.ReadAsVARCHAR(dataReader, ordinal);
        }
