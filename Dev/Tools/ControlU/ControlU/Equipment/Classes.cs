...
namespace ControlU.Equipment
{
    ...
    public class TelnetConnection : IDisposable
    {
        ...
        {
            string t = "";
            long WaitReadfrom = Helpers.WinAPITime.GetTimeStamp();// DateTime.Now.Ticks;
            WriteLine(str);
            while (!m_Stream.DataAvailable && Helpers.WinAPITime.GetTimeStamp() - WaitReadfrom < 20000000)
            {
    ...
    class UdpStreaming : IDisposable
    {
        ...
        public Byte[] ByteRead()
        {
            ...
            long WaitReadfrom = Helpers.WinAPITime.GetTimeStamp();// DateTime.Now.Ticks;
            while (m_Client.Available == 0 && Helpers.WinAPITime.GetTimeStamp() - WaitReadfrom < 20000000)
            {
                System.Threading.Thread.Sleep(1);
                //System.Diagnostics.Debug.WriteLine(Helpers.WinAPITime.GetTimeStamp() - WaitReadfrom);
            }
    ...
    public static class DeviceClass
    {
        ...
        public static DeviceClassData SpecAn = new DeviceClassData() { ClassName = "Spectrum Analyzer", Id = 1, InstrManufacruresInfo = "" };
        public static DeviceClassData RuSReceiver = new DeviceClassData() { ClassName = "R&S Receiver", Id = 2, InstrManufacruresInfo = "" };
        public static DeviceClassData RuSTSMx = new DeviceClassData() { ClassName = "R&S Network Analyzer TSMx", Id = 3, InstrManufacruresInfo = "" };
        public static DeviceClassData SignalHound = new DeviceClassData() { ClassName = "SignalHound", Id = 4, InstrManufacruresInfo = "SignalHound BB60C" };
        public static DeviceClassData WR61 = new DeviceClassData() { ClassName = "WRLS", Id = 5, InstrManufacruresInfo = "WR61" };
        public static DeviceClassData GNSS = new DeviceClassData() { ClassName = "GNSS", Id = 6, InstrManufacruresInfo = "NMEA0183" };
        public class DeviceClassData
        {
            public string ClassName { get; set; }
            public int Id { get; set; }
            public string InstrManufacruresInfo { get; set; }
        }
    }


    public static class InstrManufacrures
    {
        //public InstrManufacrures() { }
        public static ParamWithUI Unk = new ParamWithUI() { Parameter = "0", UI = "Unknown", UIShort = "Unk" };
        public static ParamWithUI RuS = new ParamWithUI() { Parameter = "1", UI = "Rohde&Schwarz", UIShort = "R&S" };
        public static ParamWithUI Keysight = new ParamWithUI() { Parameter = "2", UI = "Keysight Technologies", UIShort = "Keysight" };
        public static ParamWithUI Anritsu = new ParamWithUI() { Parameter = "3", UI = "Anritsu", UIShort = "Anritsu" };
        public static ParamWithUI SignalHound = new ParamWithUI() { Parameter = "4", UI = "SignalHound", UIShort = "SignalHound" };
