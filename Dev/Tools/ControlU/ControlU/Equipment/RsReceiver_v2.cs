...
namespace ControlU.Equipment
{
    public class RsReceiver_v2 : PropertyChangedBase
    {
        ...
        {
            get { return _ShowWaterfall; }
            set { _ShowWaterfall = value; OnPropertyChanged("ShowWaterfall"); }
        }
        private bool _ShowWaterfall = false;
        #region Global
        ...
        private ObservableCollection<AllRCVUnqData> AllUniqueData = new ObservableCollection<AllRCVUnqData>
        {
            ...
            new AllRCVUnqData
            {
                ...
                RangeLevelStep = 10,
                Battery = false,
                DFSQUModes = new ObservableCollection<ParamWithUI>()
                {
            ...
            new AllRCVUnqData
            {
                InstrManufacrure = 1, InstrModel = "DDF007", InstrOption = new List<RCVOption>()
                {
                    #region 
                    new RCVOption() { Type = "PS", Designation = "Panorama Scan", Globaltype = "Panorama Scan"},
                    new RCVOption() { Type = "IR", Designation = "Internal Recording", Globaltype = "Internal Recording"},
            ...
            new AllRCVUnqData
            {
                InstrManufacrure = 1, InstrModel = "DDF550", InstrOption = new List<RCVOption>()
                {
                    #region 
                    new RCVOption() { Type = "PS", Designation = "Panorama Scan", Globaltype = "Panorama Scan"},
                    new RCVOption() { Type = "IR", Designation = "Internal Recording", Globaltype = "Internal Recording"},
            ...
            new AllRCVUnqData
            {
                InstrManufacrure = 1, InstrModel = "EM200", InstrOption = new List<RCVOption>()
                {
                    #region 
                    new RCVOption() { Type = "PS", Designation = "Panorama Scan", Globaltype = "Panorama Scan"},
                    new RCVOption() { Type = "FS", Designation = "Fieldstrength Measurement", Globaltype = "Fieldstrength Measurement"},
                    new RCVOption() { Type = "PC", Designation = "Polychrome Spectrum", Globaltype = "Polychrome Spectrum"},
                    new RCVOption() { Type = "MAP", Designation = "Mapping", Globaltype = "Mapping"},
                    new RCVOption() { Type = "TSA", Designation = "Time Stamp Accuracy", Globaltype = "Time Stamp Accuracy"},
                    new RCVOption() { Type = "ZS", Designation = "Time Domain Measurement", Globaltype = "Time Domain Measurement"},
                    new RCVOption() { Type = "DF", Designation = "Direction Finder", Globaltype = "Direction Finder"},
                    new RCVOption() { Type = "XG", Designation = "10G Ethernet Interface", Globaltype = "-10G Ethernet Interface"},
                    #endregion
                },
                LoadedInstrOption = new List<RCVOption>() { },
                Modes = new ObservableCollection<mode>
                ...
                DemodFreq = false,
                DemodBW = new decimal[] { 100, 150, 300, 600, 1000, 1500, 2100, 2400, 2700, 3100, 4000, 4800, 6000, 8300, 9000, 12000, 15000, 25000, 30000, 50000, 75000, 120000, 150000, 250000, 300000, 500000, 800000, 1000000, 1250000, 1500000, 2000000, 5000000, 8000000, 10000000, 12500000, 15000000, 20000000, 40000000 },
                Demod =  new string[] { "AM", "FM", "PULSE", "PM", "IQ", "ISB", "CW", "USB", "LSB" },
                FFMStepBW = new decimal[] { 0.625m, 1.25m, 2.5m, 3.125m, 6.25m, 12.5m, 25, 31.25m, 50, 62.5m, 100, 125, 200, 250, 312.5m, 500, 625, 1000, 1250, 2000, 2500, 3125, 5000, 6250, 8333, 10000, 12500, 20000, 25000, 50000, 100000, 200000, 500000, 1000000, 2000000 },
                DFBW = new decimal[] { 50, 100, 150, 300, 600, 1000, 1500, 2100, 2400, 2700, 3100, 4000, 4800, 6000, 8333, 9000, 12000, 15000, 25000, 30000, 50000, 75000, 120000, 150000, 250000, 300000, 500000, 800000, 1000000, 1250000, 1500000, 2000000 },
                PSCANStepBW = new decimal[] { 100, 125, 200, 250, 312.5m, 500, 625, 1000, 1250, 2000, 2500, 3125, 5000, 6250, 8333, 10000, 12500, 20000, 25000, 50000, 100000, 200000, 500000, 1000000, 2000000 },
                FFMSpanBW = new decimal[] { 1000, 2000, 5000, 10000, 20000, 50000, 100000, 200000, 500000, 1000000, 2000000, 5000000, 10000000, 20000000, 40000000 },
                FFTModes = new ObservableCollection<ParamWithUI>
                {
                    new ParamWithUI() {UI = "MINIMUM", Parameter = "MIN"},
                    new ParamWithUI() {UI = "MAXIMUM", Parameter = "MAX"},
                ...
                SelectivityChangeable = false,//true, временно бо нет комманд
                SelectivityModes = new ObservableCollection<ParamWithUI>()
                {
                    new ParamWithUI() {UI = "AUTO", Parameter = "AUTO"},
                    new ParamWithUI() {UI = "NORMAL", Parameter = "NORM"},
        ...
        #region MeasTime
        decimal minMeasTime = 0.0005M;
        public decimal MeasTime
        {
            get { return _MeasTime; }
            set { if (value >= minMeasTime && MeasTime <= 900) _MeasTime = value; OnPropertyChanged("MeasTime"); }
        }
        ...
        public decimal BatteryCapacity
        {
            ...
            set { _BatteryCapacity = value; OnPropertyChanged("BatteryCapacity"); }
        }
        private decimal _BatteryCapacity = 0;
        ...
        public decimal BatteryVoltage
        {
            ...
            set { _BatteryVoltage = value; OnPropertyChanged("BatteryVoltage"); }
        }
        private decimal _BatteryVoltage = 0;

        public decimal BatteryCurrente
        {
            get { return _BatteryCurrente; }
            set { _BatteryCurrente = value; OnPropertyChanged("BatteryCurrente"); }
        }
        private decimal _BatteryCurrente = 0;
        #endregion Battery
        public string AntennaSelectedName
        {
            get { return _AntennaSelectedName; }
            set { _AntennaSelectedName = value; OnPropertyChanged("AntennaSelectedName"); }
        }
        private string _AntennaSelectedName = "";
        public int AntennaSelected
        {
            get { return _AntennaSelected; }
            set { _AntennaSelected = value; OnPropertyChanged("AntennaSelected"); }
        }
        private int _AntennaSelected = 1;

        #region Audio
        public StreamPlayer player = null;
        public bool AudioStreamState
        {
            get { return _AudioStreamState; }
            set { _AudioStreamState = value; OnPropertyChanged("AudioStreamState"); }
        }
        private bool _AudioStreamState;
        ...
        public int AudioVolume
        {
            ...
            set
            {
                if (value > 100) _AudioVolume = 100;
                else if (value < 0) _AudioVolume = 0;
                else _AudioVolume = value;
                OnPropertyChanged("AudioVolume");
            }
        }
        ...
        public ObservableCollection<AudioFormat> AudioFormats
        {
            ...
            set { _AudioFormats = value; OnPropertyChanged("AudioFormats"); }
        }
        private ObservableCollection<AudioFormat> _AudioFormats = new ObservableCollection<AudioFormat>()
        {
            new AudioFormat(){Id = 1, SampleRate = 32000, BitPerSample = 16, Channels = 2, DataRate = 128000, FrameLength = 4  },
            new AudioFormat(){Id = 2, SampleRate = 32000, BitPerSample = 16, Channels = 1, DataRate = 64000, FrameLength = 2  },
            new AudioFormat(){Id = 3, SampleRate = 32000, BitPerSample = 8, Channels = 2, DataRate = 64000, FrameLength = 2  },
            new AudioFormat(){Id = 4, SampleRate = 32000, BitPerSample = 8, Channels = 1, DataRate = 32000, FrameLength = 1  },
            new AudioFormat(){Id = 5, SampleRate = 16000, BitPerSample = 16, Channels = 2, DataRate = 64000, FrameLength = 4  },
            new AudioFormat(){Id = 6, SampleRate = 16000, BitPerSample = 16, Channels = 1, DataRate = 32000, FrameLength = 2  },
            new AudioFormat(){Id = 7, SampleRate = 16000, BitPerSample = 8, Channels = 2, DataRate = 32000, FrameLength = 2  },
            new AudioFormat(){Id = 8, SampleRate = 16000, BitPerSample = 8, Channels = 1, DataRate = 16000, FrameLength = 1  },
            new AudioFormat(){Id = 9, SampleRate = 8000, BitPerSample = 16, Channels = 2, DataRate = 32000, FrameLength = 4  },
            new AudioFormat(){Id = 10, SampleRate = 8000, BitPerSample = 16, Channels = 1, DataRate = 16000, FrameLength = 2  },
            new AudioFormat(){Id = 11, SampleRate = 8000, BitPerSample = 8, Channels = 2, DataRate = 16000, FrameLength = 2  },
            new AudioFormat(){Id = 12, SampleRate = 8000, BitPerSample = 8, Channels = 1, DataRate = 8000, FrameLength = 1  }
        };
        private AudioFormat AudioFormatToSet;
        public AudioFormat AudioFormat
        {
            get { return _AudioFormat; }
            set { _AudioFormat = value; OnPropertyChanged("AudioFormat"); }
        }
        private AudioFormat _AudioFormat = new AudioFormat() { Id = 1, SampleRate = 32000, BitPerSample = 16, Channels = 2, DataRate = 128000, FrameLength = 4 };
        ...
        {
            get { return _SaveAllData; }
            set { SetSaveAllDataName(); index = 0; SaveIndex = 0; _SaveAllData = value; OnPropertyChanged("SaveAllData"); }
        }
        private bool _SaveAllData = false;
        public int SaveIndex
        {
            get { return _SaveIndex; }
            set { _SaveIndex = value; OnPropertyChanged("SaveIndex"); }
        }
        private int _SaveIndex = 0;
        int index = 0;
        #endregion Global

        private string SaveAllDataName = "";
        private long SaveAllDataSize = 0;
        private long SaveAllDataSizeMax = 500_000_000;
        private void SetSaveAllDataName()
        {
            SaveAllDataSize = 0;

            int ind = 1;
            string[] Files = help.GetFileNames(App.Sett.Screen_Settings.ScreenFolder, "Save*.*");
            if (Files.Length > 0)
            {
                for (int i = 0; i < Files.Length; i++)
                {
                    int f = 0;
                    int.TryParse(Files[i].Replace("Save_", ""), out f);
                    ind = Math.Max(ind, f);
                }
                ind++;
            }
            SaveAllDataName = "Save_" + string.Format("{0:00000}", ind);
        }
        ...
        private int _DFSQUModeIndex;
        public int DFSQUModeIndex
        {
            get { return _DFSQUModeIndex; }
            set
            {
                if (_DFSQUModeIndex != value && value > -1 && value < UniqueData.DFSQUModes.Count)
                {
                    _DFSQUModeIndex = value;
                    DFSQUMode = UniqueData.DFSQUModes[_DFSQUModeIndex];
                    OnPropertyChanged("DFSQUModeIndex");
                }
            }
        }
        private ParamWithUI _DFSQUMode;
        public ParamWithUI DFSQUMode
        {
            get { return _DFSQUMode; }
            set { _DFSQUMode = value; OnPropertyChanged("DFSQUMode"); }
        }
        ...
        public int DFBandwidthInd
        {
            ...
            set
            {
                if (value > -1 && value < UniqueData.DFBW.Length)
                {
        ...
        private void BatteryWatch(object sender, System.Timers.ElapsedEventArgs e)
        {
            if (IsRuning && Run == true && tc.IsOpen == true)
            {
                SetToDelegate(GetBatteryInfo);
            }
        }
        ...
        private void AllAudioUdpTimeWorks()
        {
            while (DataCycle)
            {
                //Temp = "";
                LastUpdateAudio = DateTime.Now.Ticks;
                //foreach (Delegate d in UdpDM.GetInvocationList())
                //{
                //    Temp += ((DoubMod)d).Method.Name + "\r\n";
                //}
                ...
                if (tc.IsOpen)
                {
                    ...
                    if (UniqueData.InstrModel == "EM100" || UniqueData.InstrModel == "PR100" || UniqueData.InstrModel == "DDF007")
                    {
                        if (App.Sett.RsReceiver_Settings.IntegratedGPS && UniqueData.LoadedInstrOption.Exists(item => item.Type == "GP"))
                        {
                            ...
                            string[] ant = tc.Query("ROUTe:PATH:CATalog?").TrimEnd().Split(',');
                            UniqueData.Antennas.Clear();
                            for (int i = 0; i < ant.Length; i++)
                            {
                                UniqueData.Antennas.Add(new ParamWithUI() { UI = ant[i], Parameter = "(@" + (i + 1).ToString() + ")" });
                            }
                            AntennaSelectedName = tc.Query("SYSTem:ANTenna:USED?").TrimEnd();
                            for (int i = 0; i < UniqueData.Antennas.Count; i++)
                            {
                                if (UniqueData.Antennas[i].UI.Contains(AntennaSelectedName))
                                    AntennaSelected = i;
                            }
                            //List<string> an = new List<string>() { };
                            ////string sel = tc.Query("ROUTe:PATH:DEFine?");//.TrimEnd();
                            //for (int i = 0; i < UniqueData.Antennas.Count; i++)
                            //{
                            //    UniqueData.Antennas[i].Parameter = tc.Query("ROUTe:PATH? " + UniqueData.Antennas[i].UI).TrimEnd();// + ";:SYST:ERR?");
                            //    Thread.Sleep(300);
                            //    //UniqueData.Antennas[i].Parameter = tc.Read().TrimEnd();//.Split(';')[0];
                            //    //Thread.Sleep(300);
                            //}
                        }
                    }
                    ...
                    //string ssssss = tc.Query("TRAC:UDP? MAX").TrimEnd();
                    //int k = int.Parse(ssssss);
                    //ssssss += "\r\n";
                    //for (int tt = 0; tt < k; tt++)
                    //{
                    //    ssssss += tc.Query($"TRAC:UDP? {tt}").TrimEnd() + "\r\n";
                    //}
                    #endregion
                    if (UniqueData.Battery)
                    {
                        BatTmr.AutoReset = true;
                        BatTmr.Enabled = true;
                        BatTmr.Elapsed += BatteryWatch;
                        BatTmr.Start();
                    }
                }
            }
            ...
            if (tc.IsOpen)
            {
                ...
                try
                {
                    ...
                    else if (UniqueData.InstrModel.Contains("DDF2") || UniqueData.InstrModel.Contains("EB5") || UniqueData.InstrModel.Contains("ESMD") || UniqueData.InstrModel.Contains("DDF550"))
                    {
                        ...
                        //FFMFreqSpanInd = System.Array.IndexOf(UniqueData.FFMSpanBW, decimal.Parse(data[3]));
                        //FFMStepInd = System.Array.IndexOf(UniqueData.FFMStepBW, decimal.Parse(data[4]));
                        ...
                        //{
                        //    if (data[8].Contains(UniqueData.SelectivityModes[j].Parameter)) { SelectivityMode = UniqueData.SelectivityModes[j]; }// есть ли она вообще в EM100/PR100
                        //}
                    ...
                    else if (UniqueData.InstrModel.Contains("EM200"))
                    {
                        minMeasTime = 0.0001m;
                        Thread.Sleep(10);
                        string send = ":CALCulate:PIFPan:RLEVel?;" + //++
                        ...
                        ATT = Int32.Parse(data[i]);
                        i++;
                        if (data[i].Contains("#14(@0)"))
                        {
                            AntennaSelected = 0;
                        }
                        else if (data[i].Contains("#14(@1)"))
                        {
                            AntennaSelected = 1;
                        }
                        i++;
        ...
        public void SetStreamingMode()
        {
            if (tc.IsOpen)
            {
                ...
                try
                {
                    ...
                    {
                        if (UniqueData.InstrModel.Contains("EM200"))
                        {
                            string tagoff = "TRAC:UDP:TAG:OFF \"" + MyIP + "\", " + UDPPort.ToString() + ", FSC, MSC, IFP, ZSP";
                            if (App.Sett.RsReceiver_Settings.IntegratedGPS)
                            {
                                //SYST:GNSS:DATA?  356 str
                                tagoff = "TRAC:UDP:TAG:OFF \"" + MyIP + "\", " + UDPPort.ToString() + ", FSC, MSC, IFP, ZSP, GPSC";
                                //Rottmr.Elapsed -= TimerGetGNSSData;
                                //Rottmr.Stop();
                            }
                            tc.WriteLine(tagoff);
                            tc.WriteLine("TRAC:UDP:FLAG:OFF \"" + MyIP + "\", " + UDPPort.ToString() + ", \"VOLT:AC\", \"FREQ:OFFS\", \"FSTR\", \"CHAN\", \"FREQ:RX\", \"FREQ:HIGH:RX\", \"PRIV\", \"OPT\", \"IFP\", \"ZSP:VOLT:AC\", \"ZSP:FM\"");//\"FSTR\", 
                            //tc.WriteLine("TRAC:UDP:FLAG:ON \"" + MyIP + "\", " + UDPPort.ToString() + ", \"FSTR\", \"VOLT:AC\", \"swap\", \"opt\"");//\"FSTR\", 
                    ...
                    else if (LastMode.Mode == "PSCAN")
                    {
                        if (UniqueData.InstrModel.Contains("EM200"))
                        {
                            string tagoff = "TRAC:UDP:TAG:OFF \"" + MyIP + "\", " + UDPPort.ToString() + ", IFP, PSC";
                            if (App.Sett.RsReceiver_Settings.IntegratedGPS)
                            {
                                tagoff = "TRAC:UDP:TAG:OFF \"" + MyIP + "\", " + UDPPort.ToString() + ", IFP, PSC, GPSC";
                            }
                            tc.WriteLine(tagoff);
                            tc.WriteLine("TRAC:UDP:FLAG:OFF \"" + MyIP + "\", " + UDPPort.ToString() + ", \"VOLT:AC\", \"PRIV\", \"OPT\", \"IFP\"");
                            //tc.WriteLine("TRAC:UDP:FLAG:OFF \"" + MyIP + "\", " + UDPPort.ToString() + ", 'freq:rx', 'freq:high:rx', 'volt:ac', 'opt'");
                            //tc.WriteLine("TRAC:UDP:FLAG:OFF \"" + MyIP + "\", " + UDPPort.ToString() + ", 'volt:ac', 'opt'");
                            tc.WriteLine("SENS:FUNC:OFF \"VOLT:AC\"");
                    ...
                    if (Mode.Mode == "FFM")
                    {
                        if (UniqueData.InstrModel.Contains("EM200"))
                        {
                            ...
                            string tagoff = "TRAC:UDP:TAG:ON \"" + MyIP + "\", " + UDPPort.ToString() + ", FSC, MSC, IFP, ZSP";
                            if (App.Sett.RsReceiver_Settings.IntegratedGPS)
                            {
                                tagoff = "TRAC:UDP:TAG:ON \"" + MyIP + "\", " + UDPPort.ToString() + ", FSC, MSC, IFP, ZSP, GPSC";
                            }
                            tc.WriteLine(tagoff);
                            tc.WriteLine("TRAC:UDP:FLAG:ON \"" + MyIP + "\", " + UDPPort.ToString() + ", \"VOLT:AC\", \"FREQ:OFFS\", \"FSTR\", \"CHAN\", \"FREQ:RX\", \"FREQ:HIGH:RX\", \"PRIV\", \"OPT\", \"IFP\", \"ZSP:VOLT:AC\", \"ZSP:FM\"");//\"FSTR\", 
                            //tc.WriteLine("TRAC:UDP:FLAG:ON \"" + MyIP + "\", " + UDPPort.ToString() + ", \"FSTR\", \"VOLT:AC\", \"swap\", \"opt\"");//\"FSTR\", 
                    ...
                    else if (Mode.Mode == "DF")
                    {
                        ...
                        else if (UniqueData.InstrModel.Contains("DDF2") || UniqueData.InstrModel.Contains("EB5") || UniqueData.InstrModel.Contains("ESMD") || UniqueData.InstrModel.Contains("DDF550"))
                        {
                            ...
                            tc.WriteLine("SENS:FUNC:ON \"VOLT:AC\"");
                            //tc.WriteLine("<?xml version=\"1.0\" ?><Request id = \"91\" type=\"set\"><Command name = \"DfMode\"><Param name = \"eOperationMode\">DFMODE_FFM</Param></Command></Request>");
                            //tc.WriteLine("<?xml version=\"1.0\" ?><Request id = \"91\" type=\"set\"><Command name = \"DfMode\"><Param name = \"eOperationMode\">DFMODE_FFM</Param></Command></Request>");
                        }
                    ...
                    else if (Mode.Mode == "PSCAN")
                    {
                        if (UniqueData.InstrModel.Contains("EM200"))
                        {
                            string tagoff = "TRAC:UDP:TAG:ON \"" + MyIP + "\", " + UDPPort.ToString() + ", IFP, PSC";
                            if (App.Sett.RsReceiver_Settings.IntegratedGPS)
                            {
                                tagoff = "TRAC:UDP:TAG:ON \"" + MyIP + "\", " + UDPPort.ToString() + ", IFP, PSC, GPSC";
                            }
                            tc.WriteLine(tagoff);
                            tc.WriteLine("TRAC:UDP:FLAG:ON \"" + MyIP + "\", " + UDPPort.ToString() + ", \"VOLT:AC\", \"PRIV\", \"OPT\", \"IFP\"");
                            //tc.WriteLine("TRAC:UDP:FLAG:ON \"" + MyIP + "\", " + UDPPort.ToString() + ", 'freq:rx', 'freq:high:rx', 'volt:ac', 'opt'");
                            //tc.WriteLine("TRAC:UDP:FLAG:ON \"" + MyIP + "\", " + UDPPort.ToString() + ", 'volt:ac', 'opt'");
                            tc.WriteLine("SENS:FUNC:ON \"VOLT:AC\"");
                        }
                        else
                        {
        ...
        private void GetStrength()
        {
            if (tc.IsOpen)
            {
                try
                {
                    tc.WriteLine("SENSe:DATA? \"VOLTage:AC\"");
                    byte[] str = tc.ReadBytes();
                    if (str.Length > 0)
                    {
        ...
        private void ReaderStream()
        {
            ...
            if (uc.IsOpen && _DataCycle)
            {
                ...
                if (t.Length > 0)
                {
                    ...
                    {
                        HeaderLength = 28;
                        optHeaderLength = (UInt16)((t[22] << 8) | (t[23]));
                        DataFrom = (UInt16)(optHeaderLength + HeaderLength);
                        DataLength = (UInt16)((t[20] << 8) | (t[21]));
                    }
                    else
                    {
                        HeaderLength = 76;
                        Length = (UInt16)((t[20] << 24) | (t[21] << 16) | (t[22] << 8) | (t[23]));
                        optHeaderLength = (UInt16)((t[22] << 8) | (t[23]));

                        DataLength = (UInt32)((t[40] << 24) | (t[41] << 16) | (t[42] << 8) | (t[43]));
                        DataFrom = (UInt16)(optHeaderLength + HeaderLength);

                    }
                    //UInt16 HeaderLength = 28;
                    //UInt16 optHeaderLength = (UInt16)((t[22] << 8) | (t[23]));
                    //UInt16 DataFrom = (UInt16)(optHeaderLength + HeaderLength);
                    //UInt16 DataLength = (UInt16)((t[20] << 8) | (t[21]));
                    FinishPscan = false;
                    ...
                    {
                        int AudioMode = BitConverter.ToInt16(t, 28);
                        int FrameLength = BitConverter.ToInt16(t, 30);
                        byte[] bfreq = new byte[8]; Array.Copy(t, 32, bfreq, 0, 4); Array.Copy(t, 50, bfreq, 4, 4);
                        int Bandwidth = BitConverter.ToInt32(t, 36);
                        UInt64 freqCentr = BitConverter.ToUInt64(bfreq, 0);
                        int Demodulation = BitConverter.ToUInt16(t, 40);
                        string DemodulationString = System.Text.Encoding.ASCII.GetString(t, 42, 8);
                        UInt64 TimeStamp = BitConverter.ToUInt64(t, 60);
                        DateTime dt = new DateTime(1970, 1, 1, 0, 0, 0, System.DateTimeKind.Utc);
                        dt = dt.AddTicks((long)TimeStamp / 100);
                        dt = dt.ToLocalTime();
                        if (AudioFormat.Id != AudioMode)
                        {
                            for (int i = 0; i < AudioFormats.Count; i++)
                            {
                                if (AudioMode == AudioFormats[i].Id)
                            ...
                            if (player != null)
                            {
                                ...
                                player.Dispose();
                                player = new StreamPlayer(AudioFormat);
                                player.PlayAsync();
                                player.Volume = ((float)AudioVolume) / 100;
                            }
                        ...
                        short[] audio = new short[] { };
                        try
                        {
                            if (_AudioFormat.FrameLength == 4 || _AudioFormat.FrameLength == 2)
                            {
                                if (_AudioFormat.BitPerSample == 16)
                                {
                                    audio = new short[DataLength * _AudioFormat.Channels];
                                    for (int i = 0; i < DataLength * _AudioFormat.Channels; i++)
                                    {
                                        audio[i] = BitConverter.ToInt16(t, (int)DataFrom + i * 2);
                                    }
                                }
                                else if (_AudioFormat.BitPerSample == 8)
                                {
                                    audio = new short[DataLength * _AudioFormat.Channels / 2];
                                    for (int i = 0; i < DataLength * _AudioFormat.Channels / 2; i++)
                                    {
                                        audio[i] = BitConverter.ToInt16(t, (int)DataFrom + i * 2);
                                    }
                                }
                            }
                            else if (_AudioFormat.FrameLength == 1)
                            {
                                if (_AudioFormat.BitPerSample == 16)
                                {
                                    audio = new short[DataLength * _AudioFormat.Channels / 2];
                                ...
                                else if (_AudioFormat.BitPerSample == 8)
                                {
                                    ...
                                    for (int i = 0; i < DataLength * _AudioFormat.Channels / 2; i++)
                                    {
                                        audio[i] = BitConverter.ToInt16(t, (int)DataFrom + i * 2); //(short)(t[DataFrom + i] * 255);
                                    }
                                }
                            }
                        }
                    ...
                    else if (streammode == 501)//FFM IFPan
                    {
                        ...
                        if (freqstart != TraceTemp[0].freq || TraceTemp.Length != DataLength || freqstop != TraceTemp[TraceTemp.Length - 1].freq || step != (TraceTemp[1].freq - TraceTemp[0].freq))
                        {
                            #region reset
                            TraceTemp = new tracepoint[DataLength];
                            if (LevelUnitInd == 0)
                            {
                                for (int i = 0; i < TraceTemp.Length; i++)
                                {
                                    tracepoint p = new tracepoint()
                                    {
                                        ...
                                        level = (double)((Int16)((t[i * 2 + DataFrom + 1] << 8) | (t[i * 2 + DataFrom]))) / 10
                                    };
                                    TraceTemp[i] = p;
                                }
                            }
                            else if (LevelUnitInd == 1)
                            {
                                for (int i = 0; i < DataLength; i++)
                                {
                                    ...
                                    {
                                        freq = freqstart + step * i,
                                        level = ((double)((Int16)((t[i * 2 + DataFrom + 1] << 8) | (t[i * 2 + DataFrom]))) / 10) - 107
                                    };
                                    TraceTemp[i] = p;
                                }
                            }
                        ...
                        else
                        {
                            ...
                            if (LevelUnitInd == 0)
                            {
                                ...
                                for (int i = 0; i < TraceTemp.Length; i++)
                                {
                                    TraceTemp[i].level = (double)((Int16)((t[i * 2 + DataFrom + 1] << 8) | (t[i * 2 + DataFrom]))) / 10;
                                }
                            }
                            else if (LevelUnitInd == 1)
                            {
                                for (int i = 0; i < TraceTemp.Length; i++)
                                {
                                    TraceTemp[i].level = ((double)((Int16)((t[i * 2 + DataFrom + 1] << 8) | (t[i * 2 + DataFrom]))) / 10) - 107;
                                }
                            }
                            #endregion
                        }
                    ...
                    else if (streammode == 1201)//PSCan
                    {
                        ...
                        Int16 shift = (Int16)((t[DataLength * 2 + DataFrom - 1] << 8) | (t[DataLength * 2 + DataFrom - 2]));
                        int ind = (int)DataLength;
                        if (shift == 2000)
                        {
                            FinishPscan = true;
                            ind--;
                        ...
                        #endregion 
                        int itd = (int)DataFrom + (int)DataLength * 2;
                        int itu = (int)DataFrom + (int)DataLength * 2 + (int)DataLength * 4;
                        ...
                        for (int i = 0; i < ind; i++)
                        {
                            if (freqindex < TraceTemp.Length)
                            {
                                if (LevelUnitInd == 0)
                                {
                                    TraceTemp[freqindex].level = (double)((Int16)((t[i * 2 + DataFrom + 1] << 8) | (t[i * 2 + DataFrom]))) / 10;
                                }
                                else if (LevelUnitInd == 1)
                                {
                                    TraceTemp[freqindex].level = (double)((Int16)((t[i * 2 + DataFrom + 1] << 8) | (t[i * 2 + DataFrom]))) / 10 - 107;
                                }
                                freqindex++;
                            }
                        }
                    ...
                    else if (streammode == 1401)//DFPan
                    {
                        ...
                        if (freqCentr > 0 && freqSpan > 0)
                        {
                            ...
                            if (UniqueData.InstrModel.Contains("PR100") || UniqueData.InstrModel.Contains("EM100") || UniqueData.InstrModel.Contains("DDF007"))
                            {
                    ...
                    else if (streammode == 10501)//FFM IFPan OO new
                    {
                        #region
                        byte[] bfreq = new byte[8];
                        Array.Copy(t, 76, bfreq, 0, 4);
                        Array.Copy(t, 92, bfreq, 4, 4);
                        UInt64 freqCentr = BitConverter.ToUInt64(bfreq, 0);
                        UInt32 freqSpan = BitConverter.ToUInt32(t, 80);
                        decimal freqstart = freqCentr - (freqSpan / 2);
                        decimal freqstop = freqCentr + (freqSpan / 2);
                        decimal step = BitConverter.ToUInt32(t, 116) / BitConverter.ToUInt32(t, 120);
                        //decimal step = freqSpan / ((Int16)((t[20] << 8) | (t[21])) - 1);
                        for (int i = 0; i < UniqueData.FFMStepBW.Length; i++)
                        {
                            if (step == (int)UniqueData.FFMStepBW[i])
                        ...
                        if (FFMFreqCentr != freqCentr || FreqCentr != freqCentr)
                        {
                            FFMFreqCentr = freqCentr; FreqCentr = freqCentr;
                        }
                        if (FFMFreqSpan != freqSpan || FreqSpan != freqSpan)
                        {
                            if (System.Array.IndexOf(UniqueData.FFMSpanBW, freqSpan) > 0)
                    ...
                    else if (streammode == 11201)//PSCAN IFPan OO new
                    {
                        #region     
                        DataFrom = 138;// + DataLength * 10;
                        decimal freqStep = BitConverter.ToUInt32(t, HeaderLength + 32) / BitConverter.ToUInt32(t, HeaderLength + 36);
                        for (int i = 0; i < UniqueData.PSCANStepBW.Length; i++)
                        {
                            if (freqStep == (int)UniqueData.PSCANStepBW[i])
                            { freqStep = UniqueData.PSCANStepBW[i]; PScanStepInd = i; }
                        }
                        byte[] bstart = new byte[8];
                        Array.Copy(t, HeaderLength + 0, bstart, 0, 4);
                        Array.Copy(t, HeaderLength + 12, bstart, 4, 4);
                        byte[] bstop = new byte[8];
                        Array.Copy(t, HeaderLength + 4, bstop, 0, 4);
                        Array.Copy(t, HeaderLength + 16, bstop, 4, 4);
                        UInt64 start = BitConverter.ToUInt64(bstart, 0);
                        UInt64 stop = BitConverter.ToUInt64(bstop, 0);
                        //Int16 shift = (Int16)((t[DataLength * 2 + DataFrom - 1] << 8) | (t[DataLength * 2 + DataFrom - 2]));
                        int ind = (int)DataLength;
                        ...
                        //Array.Copy(t, itu, bfreq, 4, 4);
                        //decimal freq = BitConverter.ToUInt64(bfreq, 0);
                        decimal freq = BitConverter.ToUInt64(t, HeaderLength + 40);
                        int freqindex = 0;
                        for (int j = 0; j < TraceTemp.Length; j++)
                        {
                            if (TraceTemp[j].freq == freq) freqindex = j;
                        ...
                        if (freqindex == 0)
                        { index++; }
                        //System.Diagnostics.Debug.WriteLine(freqindex);
                        for (int i = 0; i < ind; i++)
                        {
                            if (freqindex < TraceTemp.Length)
                            {
                    ...
                    if (SaveAllData)
                    {
                        //App.Sett.Screen_Settings.ScreenFolder + "\\" + ScreenName;
                        string str = Convert.ToBase64String(t);
                        //byte[] bytes = Convert.FromBase64String(str);
                        using (System.IO.StreamWriter file = new System.IO.StreamWriter(App.Sett.Screen_Settings.ScreenFolder + "\\" + SaveAllDataName + ".dat", true))
                        {
                            file.WriteLine(index.ToString() + ";" + SaveIndex.ToString() + ";" + Helpers.WinAPITime.GetTimeStamp().ToString() + ";");
                            file.WriteLine(str + ";");
                        }
                        SaveIndex++;
                        SaveAllDataSize += str.Length;
                        if (SaveAllDataSize > SaveAllDataSizeMax)
                        {
                            SetSaveAllDataName();
                        }
                    }
        ...
        private void ReaderAudioStream()
        {
            try
            {
                Thread.Sleep(new TimeSpan(10));
                if (AudioUC.IsOpen && DataCycle)
                {
                    byte[] t = AudioUC.ByteRead();
                    if (t.Length > 0)
                    {
                        UInt16 streammode = (UInt16)((t[16] << 8) | (t[17]));
                        ...
                        if (streammode == 401)//Audio
                        {
                            ...
                            if (_AudioFormat.FrameLength == 4 || _AudioFormat.FrameLength == 2)
                            {
                                ...
                                for (int i = 0; i < DataLength * _AudioFormat.Channels; i++)
                                {
                                    audio[i] = BitConverter.ToInt16(t, DataFrom + i * 2);
                                }
                            }
                            else if (_AudioFormat.FrameLength == 1)
                            {
        ...
        public void SetDemodFreq(decimal ffmdemodfreq)
        {
            FFMDemodFreq = ffmdemodfreq;
            SetToDelegate(SetDemodFreq);
        }
        ...
        #region DF
        public void SetDFBandwidtIndex(int _DFBandwidthInd)
        {
            DFBandwidthInd = _DFBandwidthInd;
            SetToDelegate(SetDFBandwidth);
        }
        public void SetDFBandwidthAuto(bool _DFBandwidthAuto)
        {
            DFBandwidthAuto = _DFBandwidthAuto;
            SetToDelegate(SetDFBandwidthAuto);
        }
        public void SetDFSQUModeInde(int _DFSQUModeIndex)
        {
            DFSQUModeIndex = _DFSQUModeIndex;
            SetToDelegate(SetDFSQUMode);
        }
        #endregion DF
        ...
        public void SetAntenna(int antennaindex)
        {
            AntennaSelected = antennaindex;
            SetToDelegate(SetAntenna);
        }
        ...
        {
            AudioFormatToSet = audioFormat;
            SetToDelegate(SetAudioFormat);
        }
        public void SetAudioStream(bool audioStreamState)
        {
        ...
        private void SetAntenna()
        {
            try
            {
                if (tc.IsOpen)
                {
                    if (UniqueData.InstrModel.Contains("EM200"))
                    {
                        tc.WriteLine($"ROUTe:VUHF:INPut (@{AntennaSelected.ToString()})");
                        Thread.Sleep(100);
                        string res = tc.Query("ROUTe:VUHF:INPut?").TrimEnd();
                ...
                //////if (tc.IsOpen)
                //////{
                //////    string res = tc.Query("SYSTem:ANTenna:USED " + UniqueData.Antennas[AntennaSelected].UI + ";:SYST:ERR?");// "ROUTe:SELect " + UniqueData.Antennas[AntennaSelected].Parameter + ";:SYST:ERR?");//ROUTe:PATH:CORRection (@10), “ADD107_Tripod”
                //////    //tc.Query("ROUTe:PATH:CORRection " + UniqueData.Antennas[AntennaSelected].Parameter+ ", " + UniqueData.Antennas[AntennaSelected].UI + ";:SYST:ERR?");// "ROUTe:SELect " + UniqueData.Antennas[AntennaSelected].Parameter + ";:SYST:ERR?");//ROUTe:PATH:CORRection (@10), “ADD107_Tripod”
                //////    string res1 = tc.Query("SYSTem:ANTenna:USED?");// 
                //////}
            }
            #region Exception
            catch (Exception exp)
        ...
        private void GetBatteryInfo()
        {
            try
            {
                if (tc.IsOpen)
                {
                    string charge = tc.Query("DIAGnostic:ADAPter?").TrimEnd();
                    BatteryCharging = charge.Contains("1") ? true : false;
                    Thread.Sleep(20);
                    string[] bat = tc.Query("DIAGnostic:MODule:BATTery? ALL").TrimEnd().Split(',');
                    BatteryCapacity = decimal.Parse(bat[0]);
                    BatteryVoltage = decimal.Parse(bat[1]) / 1000;
                    BatteryCurrente = decimal.Parse(bat[2]) / 1000;
            ...
            #endregion
            finally { TelnetDM -= GetBatteryInfo; }
        }
        ...
        private void SetAudioStream()
        {
            try
            {
                //if (AudioStreamState)
                //{
                //    player = new StreamPlayer(AudioFormats[0]);
                //    player.PlayAsync();
                ...
                if (tc.IsOpen)
                {
                    if (AudioStreamState)
                    {
                        ...
                        //tc.WriteLine("SYST:AUD:VOL MAX");
                        tc.WriteLine("SYST:AUD:DEM:VOL MAX");
                        tc.WriteLine("TRAC:UDP:TAG:ON \"" + MyIP + "\", " + UDPPort.ToString() + ", audio");
                        tc.WriteLine("TRAC:UDP:FLAG:ON \"" + MyIP + "\", " + UDPPort.ToString() + ", \"swap\", \"opt\"");

                        //AudioUC = new UdpStreaming();
                        //AudioUC.Open(MyIP, AudioUDPPort);

                        //AudioDM = sameWorkAudioUDP;
                        //AudioDM += ReaderAudioStream;
                        //AudioTr = new Thread(AllAudioUdpTimeWorks);
                        //AudioTr.Name = "RsReceiverAudioUdpThread";
                        //AudioTr.IsBackground = true;
                    ...
                    else
                    {
                        ...
                        //    AudioTr.Abort();
                        //}
                        tc.WriteLine("TRAC:UDP:TAG:OFF \"" + MyIP + "\", " + UDPPort.ToString() + ", audio");
                        tc.WriteLine("TRAC:UDP:FLAG:OFF \"" + MyIP + "\", " + UDPPort.ToString() + ", \"audio\", \"swap\", \"opt\"");
                        //tc.WriteLine("TRAC:UDP:TAG:OFF \"" + MyIP + "\", " + AudioUDPPort.ToString() + ", audio");
                        //tc.WriteLine("TRAC:UDP:FLAG:OFF \"" + MyIP + "\", " + AudioUDPPort.ToString() + ", \"audio\", \"swap\", \"opt\"");
                    }
                }
            }
            #region Exception
            ...
            #endregion
            finally { TelnetDM -= SetAudioStream; }
        }
        private void SetAudioFormat()
        {
            try
            {
                if (tc.IsOpen)
                {
                    tc.WriteLine("system:audio:remote:mode " + AudioFormatToSet.Id);
                }
            }
            #region Exception
            catch (Exception exp)
            ...
            #endregion
            finally { TelnetDM -= SetAudioFormat; }
        }
        #endregion Global
        ...
        private void SetFFMRefLevel()
        {
            try
            {
                if (tc.IsOpen)
                {
                    ...
                    else if (UniqueData.InstrModel.Contains("EB5") || UniqueData.InstrModel.Contains("DDF2") || UniqueData.InstrModel.Contains("ESMD") || UniqueData.InstrModel.Contains("DDF550") || UniqueData.InstrModel.Contains("EM200"))
                    {
        ...
        private void SetPScanRefLevel()
        {
            try
            {
                if (tc.IsOpen)
                {
                    ...
                    else if (UniqueData.InstrModel == "EB500" || UniqueData.InstrModel.Contains("DDF2") || UniqueData.InstrModel.Contains("ESMD") || UniqueData.InstrModel.Contains("DDF550"))
                    {
                        //tc.WriteLine("DISPlay:PSCAN:LEVel:REFerence " + PScanRefLevel.ToString("G29").Replace(',', '.'));
                    }
                    else if (UniqueData.InstrModel.Contains("EM200"))
        ...
        private void SetDFBandwidth()
        {
            ...
            #endregion
            finally { TelnetDM -= SetDFBandwidth; }
        }

        private void SetDFBandwidthAuto()
        {
            try
            {
                if (tc.IsOpen)
            ...
            #endregion
            finally { TelnetDM -= SetDFBandwidthAuto; }
        }
        private void GetDFBandwidthAuto()
        {
            try
            {
                if (tc.IsOpen)
            ...
            #endregion
            finally { TelnetDM -= GetDFBandwidthAuto; }
        }
        ...
        public void SetDFSQUMode()
        {
            try
            {
                if (tc.IsOpen)
                {
                    ...
                    tc.WriteLine("MEASure:DF:MODE " + DFSQUMode.Parameter);
        ...
        public void SetSettingsToMeasMon(decimal freqCentr, decimal span, decimal RBW)
        {
            if (tc.IsOpen)
            {
                try
                {
                    ...
                    else if (UniqueData.InstrModel.Contains("EB5") || UniqueData.InstrModel.Contains("ESMD") || UniqueData.InstrModel.Contains("DDF2") || UniqueData.InstrModel.Contains("DDF550") || UniqueData.InstrModel.Contains("EM200"))
                    {
        ...
        public bool Replay
        {
            ...
            set
            {
                ...
                OnPropertyChanged("Replay");
            }
        }
        private bool _Replay = false;

        public bool ReplayFileLoading
        {
            get { return _ReplayFileLoading; }
            set { _ReplayFileLoading = value; OnPropertyChanged("ReplayFileLoading"); }
        }
        private bool _ReplayFileLoading = false;

        public int ReplayMax
        {
            get { return _ReplayMax; }
            set { _ReplayMax = value; OnPropertyChanged("ReplayMax"); }
        }
        private int _ReplayMax = 0;

        public int ReplayIndex
        {
            get { return _ReplayIndex; }
            set { _ReplayIndex = value; OnPropertyChanged("ReplayIndex"); }
        }
        private int _ReplayIndex = 0;

        long ReplayTime = 0;
        List<ReplayDataPart> ReplayData = new List<ReplayDataPart>() { };

        public void LoadFileReplay(string path)
        {
            foreach (AllRCVUnqData a in AllUniqueData)
            {
                if (a.InstrModel.ToLower().Contains("em200"))
                {
                    UniqueData = a;
                }
            }
            ...
            ReplayFileLoading = true;
            ReplayData = new List<ReplayDataPart>() { };
            using (System.IO.StreamReader sr = new System.IO.StreamReader(path))
            {
                long t = 0;
                while (!sr.EndOfStream)
                {
                    string[] sss = sr.ReadLine().Split(';');
                    if (sss.Length == 2)
                    {
                        ReplayData.Add(new ReplayDataPart() { Data = Convert.FromBase64String(sss[0]), Time = t });
                    }
            ...
            ReplayMax = ReplayData.Count;
            ReplayIndex = 0;
            ReplayFileLoading = false;
        }
        private void ConnectReplay()
        {
            ReplayDM = sameWorkReplay;
            ReplayDM += ReaderReplay;
            ReplayTr = new Thread(AllReplayTimeWorks);
            ReplayTr.Name = "RsReceiverReplayThread";
            ReplayTr.IsBackground = true;

            ReplayTr.Start();
        }
        private void DisconnectReplay()
        {

        }
        private void sameWorkReplay()
        {
            try
            {
                //ReaderStream();
        ...
        private void AllReplayTimeWorks()
        {
            while (_Replay)
            {
                //Temp = "";
        ...
        private void ReaderReplay()
        {
            Thread.Sleep(new TimeSpan(10));
            if (_Replay && ReplayIndex < ReplayData.Count)
            {
                Byte[] t = ReplayData[ReplayIndex].Data;
                if (ReplayIndex == 0)
                {
                    ReplayTime = Helpers.WinAPITime.GetTimeStamp() - ReplayData[ReplayIndex].Time;
                }
                if (t.Length > 0 && Helpers.WinAPITime.GetTimeStamp() - ReplayData[ReplayIndex].Time > ReplayTime)
                {
                    ...
                    if (streammode == 1801)//GPS Data
                    {
                        ...
                        if (MainWindow.gps.GPSIsValid)
                        {
                            try
                            {
                                ...
                                MainWindow.gps.AngleCourse = ang;
                                MainWindow.gps.Horizontaldilution = BitConverter.ToSingle(t, 60);
                                TimeStamp = BitConverter.ToUInt64(t, 28);
                                DateTime dt = new DateTime(1970, 1, 1, 0, 0, 0, System.DateTimeKind.Utc);
                                dt = dt.AddTicks((long)TimeStamp / 100);
                                MainWindow.gps.UTCTime = dt;
                                MainWindow.gps.LocalTime = dt.ToLocalTime();
                    ...
                    else if (streammode == 11201)//PSCAN OO new
                    {
                        #region     
                        DataFrom = 138;// + DataLength * 10;
                        decimal freqStep = BitConverter.ToUInt32(t, HeaderLength + 32) / BitConverter.ToUInt32(t, HeaderLength + 36);
                        ...
                        TimeStamp = BitConverter.ToUInt64(t, HeaderLength + 24);
                        byte[] bstart = new byte[8];
                        Array.Copy(t, HeaderLength + 0, bstart, 0, 4);
                        Array.Copy(t, HeaderLength + 12, bstart, 4, 4);
                        byte[] bstop = new byte[8];
                    ...
                    #region SaveLevel
                    //using (System.IO.StreamWriter file = new System.IO.StreamWriter(App.Sett.Screen_Settings.ScreenFolder + "\\" + "Time" + ".dat", true))
                    //{
                    //    file.WriteLine(TimeStamp.ToString() + ";" + streammode.ToString() + ";");
                    //}
                    if (TempLevel == 0 && TempLevelInd == 0)
                    {
                        for (int l = 0; l < Trace1.Length; l++)
                        {
                            if (Trace1[l].freq == 583200000) //545600000)
                            {
                                TempLevelInd = l;
                            }
                        }
                    }
                    if (TempLevelInd != 0 && Trace1[TempLevelInd].level != -1000 && TempLevel != Trace1[TempLevelInd].level && MainWindow.gps.LatitudeDecimal != 0 && MainWindow.gps.LongitudeDecimal != 0)
                    {
                        using (System.IO.StreamWriter file = new System.IO.StreamWriter(App.Sett.Screen_Settings.ScreenFolder + "\\" + "Save583.2MHz" + ".dat", true))
                        {
                            file.WriteLine(MainWindow.gps.LatitudeDecimal.ToString() + ";" + MainWindow.gps.LongitudeDecimal.ToString() + ";" + Trace1[TempLevelInd].level.ToString());
                        }
                        TempLevel = Trace1[TempLevelInd].level;
                    }
                    #endregion SaveLevel
                    ReplayIndex++;
                }
        ...
        int TempLevelInd = 0;
        double TempLevel = 0, TempLat = 0, TempLon = 0;
        ulong TimeStamp = 0;
        ...
        public class StreamPlayer : IDisposable
        {
            ...
            public StreamPlayer(AudioFormat format)
            {
                stream = new SoundStream(format);
        ...
        private class SoundStream : Stream
        {
            ...
            public void SetAudioFormat(AudioFormat format)
            {
                ...
                sampleQueue = new ConcurrentQueue<byte>(BuildWavHeader(format, (int)length));
            }
            public SoundStream(AudioFormat format)
            {
                length = int.MaxValue / 2 - 36;
                position = 0;
            ...
            public static byte[] BuildWavHeader(AudioFormat format, int samplesCount)
            {
                using (var stream = new MemoryStream())
                {
                    var writer = new BinaryWriter(stream);
                    writer.Write(0x46464952);
                    writer.Write(36 + samplesCount * format.FrameLength);
                    ...
                    writer.Write(format.DataRate);
                    writer.Write(format.FrameLength);
                    writer.Write(format.BitPerSample);
                    writer.Write(0x61746164);
                    writer.Write(samplesCount * format.FrameLength);
    ...
    public class AllRCVUnqData : INotifyPropertyChanged
    {
        public int InstrManufacrure { get; set; }
        public string InstrModel { get; set; }
        public List<RCVOption> InstrOption { get; set; }
        public List<RCVOption> LoadedInstrOption
        {
            get { return _LoadedInstrOption; }
            set { _LoadedInstrOption = value; OnPropertyChanged("LoadedInstrOption"); }
        }
        private List<RCVOption> _LoadedInstrOption = new List<RCVOption>() { };
        ...
        public ObservableCollection<ParamWithUI> DFSQUModes { get; set; }
        ...
        {
            get { return _Battery; }
            set { _Battery = value; OnPropertyChanged("Battery"); }
        }
        private bool _Battery = false;

        public List<ParamWithUI> Antennas
        {
            get { return _Antennas; }
            set { _Antennas = value; OnPropertyChanged("Antennas"); }
        }
        private List<ParamWithUI> _Antennas = new List<ParamWithUI>() { };


        public bool SaveAllData
        {
            get { return _SaveAllData; }
            set { _SaveAllData = value; OnPropertyChanged("SaveAllData"); }
        }
        private bool _SaveAllData = false;

        public bool AudioAvailable
        {
            get { return _AudioAvailable; }
            set { _AudioAvailable = value; OnPropertyChanged("AudioAvailable"); }
        }
        private bool _AudioAvailable = false;
    ...
    public class AudioFormat
    {
        ...
        public short FrameLength { get; set; }
    }
    public class ReplayDataPart
    {
        public long Time;
        public byte[] Data;
    }
