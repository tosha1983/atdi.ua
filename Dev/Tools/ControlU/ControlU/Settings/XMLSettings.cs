...
namespace ControlU.Settings
{
    ...
    public class MeasMons_Set : INotifyPropertyChanged
    {
        ...
        /// <summary>
        /// 0 Not selected, 1 Spectrum Analyzer, 2 R&S Receiver, 3 R&S Network Analyzer TSMx, 4 SignalHound
        /// </summary>
        [XmlElement]
        ...
        [XmlElement]
        public int TrackDistanceStep
        {
            get { return _TrackDistanceStep; }
            set
            {
                if (value < 10) _TrackDistanceStep = 10;
                else if (value > 500) _TrackDistanceStep = 500;
                else _TrackDistanceStep = value;
                OnPropertyChanged("TrackDistanceStep");
            }
        }
        private int _TrackDistanceStep = 50;

        [XmlElement]
        public int TrackTimeStep
        {
            get { return _TrackTimeStep; }
            set {
                if (value < 1) _TrackTimeStep = 1;
                else if (value > 60) _TrackTimeStep = 60;
                else _TrackTimeStep = value;
                OnPropertyChanged("TrackTimeStep"); }
        }
        private int _TrackTimeStep = 5;
    ...
    public class Equipments_Set : INotifyPropertyChanged
    {
        ...
        public Equipment_Set SpectrumAnalyzer
        {
            ...
            set
            {
                ...
                _SpectrumAnalyzer.ID = Equipment.DeviceClass.SpecAn.Id;
                _SpectrumAnalyzer.EquipmentName = Equipment.DeviceClass.SpecAn.ClassName;
                OnPropertyChanged("SpectrumAnalyzer");
            }
        }
        private Equipment_Set _SpectrumAnalyzer = new Equipment_Set()
        {
            EquipmentName = Equipment.DeviceClass.SpecAn.ClassName,
            ID = Equipment.DeviceClass.SpecAn.Id,
        };
        ...
        public Equipment_Set RuSReceiver
        {
            ...
            {
                _RuSReceiver = value;
                _RuSReceiver.ID = Equipment.DeviceClass.RuSReceiver.Id;
                _RuSReceiver.EquipmentName = Equipment.DeviceClass.RuSReceiver.ClassName;
                OnPropertyChanged("RuSReceiver");
            }
        }
        private Equipment_Set _RuSReceiver = new Equipment_Set()
        {
            EquipmentName = Equipment.DeviceClass.RuSReceiver.ClassName,
            ID = Equipment.DeviceClass.RuSReceiver.Id,
        };
        ...
        public Equipment_Set RuSTSMx
        {
            ...
            {
                _RuSTSMx = value;
                _RuSTSMx.ID = Equipment.DeviceClass.RuSTSMx.Id;
                _RuSTSMx.EquipmentName = Equipment.DeviceClass.RuSTSMx.ClassName;
                OnPropertyChanged("RuSTSMx");
            }
        }
        private Equipment_Set _RuSTSMx = new Equipment_Set()
        {
            EquipmentName = Equipment.DeviceClass.RuSTSMx.ClassName,
            ID = Equipment.DeviceClass.RuSTSMx.Id,
        };
        ...
        //        _RuSRomesRC = value;
        //        _RuSRomesRC.ID = 4;
        //        _RuSRomesRC.EquipmentName = "R&S Romes Remote Control";
        //        OnPropertyChanged("RuSRomesRC");
        //    }
        //}
        ...
        public Equipment_Set SignalHound
        {
            ...
            {
                _SignalHound = value;
                _SignalHound.ID = Equipment.DeviceClass.SignalHound.Id;
                _SignalHound.EquipmentName = Equipment.DeviceClass.SignalHound.ClassName;
                OnPropertyChanged("SignalHound");
            }
        }
        private Equipment_Set _SignalHound = new Equipment_Set()
        {
            EquipmentName = Equipment.DeviceClass.SignalHound.ClassName,
            ID = Equipment.DeviceClass.SignalHound.Id,
        };
        ...
        public Equipment_Set WR61
        {
            ...
            {
                _WR61 = value;
                _WR61.ID = Equipment.DeviceClass.WR61.Id;
                _WR61.EquipmentName = Equipment.DeviceClass.WR61.ClassName;
                OnPropertyChanged("WR61");
            }
        }
        private Equipment_Set _WR61 = new Equipment_Set()
        {
            EquipmentName = Equipment.DeviceClass.WR61.ClassName,
            ID = Equipment.DeviceClass.WR61.Id,
        };
        ...
        public Equipment_Set GNSS
        {
            ...
            {
                _GNSS = value;
                _GNSS.ID = Equipment.DeviceClass.GNSS.Id;
                _GNSS.EquipmentName = Equipment.DeviceClass.GNSS.ClassName;
                OnPropertyChanged("GNSS");
            }
        }
        private Equipment_Set _GNSS = new Equipment_Set()
        {
            EquipmentName = Equipment.DeviceClass.GNSS.ClassName,
            ID = Equipment.DeviceClass.GNSS.Id,
        };
