...
namespace ControlU.Controls
{
    ...
    public class ATDITaskIDConverter : IValueConverter
    {
        #region IValueConverter Members
        public object Convert(object value, Type targetType, object parameter, System.Globalization.CultureInfo culture)
        {
            return ((string)value).Split('I')[0];
            // return Math.Round(((decimal)values[0]), 2).ToString() + " " + (string)values[1];
            // Do your logic with the properties here.
        }
        public object ConvertBack(object value, Type targetType, object parameter, System.Globalization.CultureInfo culture)
    ...
    public class PolarPlacementItem : ContentControl
    {
        ...
        protected override Size ArrangeOverride(Size arrangeBounds)
        {
            try
            {
                if (Azimuth != null && Elevation != null && Azimuth != double.NaN && Elevation != double.NaN)
                {
        ...
        {
            get { return (double)GetValue(AzimuthProperty); }
            set { if (value != null && value != double.NaN) SetValue(AzimuthProperty, value); }
        }
        ...
        {
            get { return (double)GetValue(ElevationProperty); }
            set { if (value != null && value != double.NaN) SetValue(ElevationProperty, value); }
        }
