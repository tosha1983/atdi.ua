...
namespace ControlU.Controls
{
    ...
    public partial class SettingsControl : System.Windows.Controls.UserControl, INotifyPropertyChanged
    {
        ...
        #region Measurment
        private void TrackDistanceStep_MouseWheel(object sender, MouseWheelEventArgs e)
        {
            Sett.MeasMons_Settings.TrackDistanceStep += help.MouseWheelOutStep(sender, e);
        }
        private void TrackTimeStep_MouseWheel(object sender, MouseWheelEventArgs e)
        {
            Sett.MeasMons_Settings.TrackTimeStep += help.MouseWheelOutStep(sender, e);
        }
