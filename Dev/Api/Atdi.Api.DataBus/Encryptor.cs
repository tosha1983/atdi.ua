...
namespace Atdi.Api.DataBus
{
    ...
    {
        private static byte[] _salt = new byte[] { 72, 94, 105, 201, 37, 195, 91, 211, 184, 173, 73, 19, 75, 245, 39, 233, 214, 8, 77, 6, 33, 17, 93, 2, 67, 51, 1, 43, 251, 3, 149, 61 };
        private static string _sharedSecret = typeof(Encryptor).AssemblyQualifiedName;
        /// <summary>
