...
//        public RabbitMQBus(string contextName, DeviceBusConfig deviceBusConfig, BusLogger logger)
//        {
...
//            {
//                HostName = this._deviceBusConfig.RabbitMqHost,
//                UserName = this._deviceBusConfig.RabbitMqUser,
//                Password = this._deviceBusConfig.RabbitMqPassword,
//            };

//            if (!string.IsNullOrEmpty(this._deviceBusConfig.RabbitMqPort))
//            {
//                this._connectionFactory.Port = int.Parse(this._deviceBusConfig.RabbitMqPort);
//            }

//            if (!string.IsNullOrEmpty(this._deviceBusConfig.RabbitMqVirtualHost))
//            {
//                this._connectionFactory.VirtualHost = this._deviceBusConfig.RabbitMqVirtualHost;
//            }
...
//            try
//            {
//                this._connection = this._connectionFactory.CreateConnection($"SDRN.Device.[{_deviceBusConfig.SdrnDeviceSensorName}].{this._contextName}");
...
//                var consumer = new QueueConsumer(consumerName, queueName, _deviceBusConfig, messageDispatcher, this, channel, this._logger);
