...
{
    public class CreateParamsCalculationHandler : ICommandHandler<CreateParamsCalculation>
    {
        private readonly AppComponentConfig _config;
        private readonly CalcServerDataLayer _dataLayer;
        private readonly IEventBus _eventBus;

        public CreateParamsCalculationHandler(AppComponentConfig config, CalcServerDataLayer dataLayer, IEventBus eventBus)
        {
            _config = config;
        ...
        public void Handle(CreateParamsCalculation command)
        {
            ...
            var stationCalibrationArgsPk = _dataLayer.Executor.Execute<IStationCalibrationArgs_PK>(query);

            _eventBus.Send(new OnCreatedParamsCalculation
            {
                 TaskId = stationCalibrationArgsPk.TaskId
            });
