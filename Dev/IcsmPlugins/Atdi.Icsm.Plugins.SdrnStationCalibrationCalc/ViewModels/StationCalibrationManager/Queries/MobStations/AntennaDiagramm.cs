...
namespace Atdi.Icsm.Plugins.SdrnStationCalibrationCalc.ViewModels.ProjectManager.Queries
{
    public class AntennaDiagramm
    {
        ...
        public PatternType Build(String Points)
        {
