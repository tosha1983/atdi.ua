...
namespace XICSM.ICSControlClient.Handlers.OnlineMeasurement.Calculation
{
    public static class BandWidthEstimation
    {
        ...
        static public BandwidthResult GetBandwidthPoint(float[] SpecrtumArrdBm, BandwidthEstimationType bandwidthEstimationType = BandwidthEstimationType.beta, double X_Beta = 1, int MaximumIgnorPoint = 1)
        {
            ...
            BandwidthResult measSdrBandwidthResults = new BandwidthResult
            {
                T1 = T1,
                T2 = T2,
                MarkerIndex = M1,
