...
{
    public partial class FormColumnAttributesList : Form
    {
        public int idweb { get; set; }
        public int idconstraint { get; set; }
        public List<string> pathlist { get; set; }
        public FormColumnAttributesList(int idwebquery,List<string> lPath)
        {
            InitializeComponent();
            idweb = idwebquery;
            pathlist = lPath;
        ...
        private void InitListView()
        {
            ...
            listView_constraints_lst.Columns.Add(new ColHeader("ID column attributes", 120, HorizontalAlignment.Left, true));
            ...
            listView_constraints_lst.Columns.Add(new ColHeader("ReadOnly attr.", 150, HorizontalAlignment.Left, true));
            listView_constraints_lst.Columns.Add(new ColHeader("Not changed add attr.", 70, HorizontalAlignment.Left, true));
            listView_constraints_lst.Columns.Add(new ColHeader("Not changed edit attr.", 70, HorizontalAlignment.Left, true));
        ...
        private void ViewData()
        {
            ...
            for (rsWebQueryNew.Open(); !rsWebQueryNew.IsEOF(); rsWebQueryNew.MoveNext())
            {
                ...
                arr[3] = rsWebQueryNew.GetI("READONLY") == 1 ? "true" : "false";
                arr[4] = rsWebQueryNew.GetI("NOTCHANGEADD") == 1 ? "true" : "false";
                arr[5] = rsWebQueryNew.GetI("NOTCHANGEEDIT") == 1 ? "true" : "false";
        ...
        private void button_delete_Click(object sender, EventArgs e)
        {
            ...
            if (DA == DialogResult.Yes)
            {
                for (int i = 0; i < listView_constraints_lst.SelectedItems.Count; i++)
                {
                    ...
                    if (int.TryParse(listView_constraints_lst.SelectedItems[i].SubItems[0].Text, out ID_))
                    {
                        IMRecordset RsWebQueryDel = new IMRecordset(ICSMTbl.WebQueryAtttributes, IMRecordset.Mode.ReadWrite);
