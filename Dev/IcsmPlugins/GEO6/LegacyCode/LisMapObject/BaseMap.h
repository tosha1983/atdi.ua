...
class MapShape
{
  ...
  public:
    ...
    virtual bool __fastcall GetExtent(DPoint& lb, DPoint& rt) {return false;};
    void SetNewFont(AnsiString FontName, int FontSize, bool isBold, bool isItalic, bool isUnderline, TColor Color);
    void SetDefaultFont(){isNewFont = false;}
    void ChangeDrawFont(HDC hMapDC);
    void RestoreDrawFont(HDC hMapDC);
...
class MapPoint: public MapShape
{
  ...
  protected:
    ...
    {
    	pointType=ptPoint;
      //fontName="MapInfo Transportation",
      symbol=0x71;
      //fontSize=16;
      isBold=false;
    };
  ...
  public:
    ...
    virtual bool __fastcall GetExtent(DPoint& lb, DPoint& rt);
...
class MapLink : public MapShape
{
  public:
    ...
    MapArrowType arrow;
  protected:
    MapLink(): MapShape(), trim(0), style(psSolid) {arrow = matNone;};
