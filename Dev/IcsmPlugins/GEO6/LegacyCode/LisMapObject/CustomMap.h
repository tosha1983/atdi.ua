...
public:		// User declarations
    ...
    MapPolygon* __fastcall ShowContour(DPoints points, AnsiString label, AnsiString hint);
    ...
    MapLabel* __fastcall ShowLabel(double lon, double lat, BSTR label, BSTR hint);
    TBaseMapFrame::Shapes __fastcall ShowDuelResult(DPoint a, DPoint b, Zone aNoise, Zone aInterf,
