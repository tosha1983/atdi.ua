...
//    bool cancelled;
    ...
    void __fastcall CalcDuel3(ILISBCTx *tx0, ILISBCTx *tx1, TDuelResult2 duel_result, TPointDuelResultArray *pointDuelResult);
    ...
    */void __fastcall CheckIdwm();/*
    ...
    void __fastcall CalcDuel(ILISBCTx* tx1, ILISBCTx* tx2, TDuelResult2* dr2, TPointDuelResultArray* pda);
