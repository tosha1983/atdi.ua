...
MapPolygon* __fastcall TCustomMapFrame::ShowContour(DPoints points, AnsiString label, AnsiString hint)
{
...
MapLabel* __fastcall TCustomMapFrame::ShowLabel(double lon, double lat, BSTR label, BSTR hint)
{
    // Пока не отображаем
    return NULL;
}
...
TBaseMapFrame::Shapes __fastcall TCustomMapFrame::ShowDuelResult(DPoint a, DPoint b, Zone aNoise, Zone aInterf,
                                   Zone bNoise, Zone bInterf, DPoint c, DPoint d)
{
