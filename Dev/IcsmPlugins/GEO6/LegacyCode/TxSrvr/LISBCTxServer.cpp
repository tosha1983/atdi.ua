...
BEGIN_OBJECT_MAP(ObjectMap)
  OBJECT_ENTRY(CLSID_LISBCTx, TLISBCTxImpl)
  OBJECT_ENTRY(CLSID_LISBCTxList, TLISBCTxListImpl)
  OBJECT_ENTRY(CLSID_LisBcObjectServerVersion, TLisBcObjectServerVersionImpl)
  OBJECT_ENTRY(CLSID_LisBcDigAllot, TLisBcDigAllotImpl)
END_OBJECT_MAP()
