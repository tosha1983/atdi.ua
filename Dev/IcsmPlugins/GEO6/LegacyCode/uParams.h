...
public:
    //ILISBCCalcCOMPtr   FCalcSrv;   //   ILISBCCalcCOMDisp   FCalcSrv;
    TCOMILISBCCalc   FCalcSrv;
    TCOMIRSAGeoPath     FPathSrv;
    TCOMIPropagation    FPropSrv;
    TCOMIRSATerrainInfo  FTerrInfoSrv;

    //  for online calculations
    /*
    TCOMILISBCTxList TxList1;
    int idxDuel1;
    TCOMILISBCTxList TxList2;
    int idxDuel2;
    */

    ServParamsArray CalcServerArray;
        AnsiString CalcServerArrayGUID;
        AnsiString CalcServerName;
    ServParamsArray PropagServerArray;
        AnsiString PropagServerArrayGUID;
        AnsiString PropagServerName;
    ...
    bool doMapInitDelay;    // MapX problems under Win7
    int mapInitDelay;       // MapX problems under Win7
    bool doMapInitInfo;     // MapX problems under Win7
    ...
    void __fastcall CheckLibVersion(AnsiString guid, DWORD* version);
    void __fastcall CheckCalcServVersion();
private:
    //Variant FCalcSrvVar;
};
