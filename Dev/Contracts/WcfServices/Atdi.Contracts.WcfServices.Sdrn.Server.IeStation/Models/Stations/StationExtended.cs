...
namespace Atdi.Contracts.WcfServices.Sdrn.Server.IeStation
{
    ...
    public class StationExtended
    {
        ...
        /// </summary>
        [DataMember]
        public DateTime? TestStopDate { get; set; }

        /// <summary>
        ///  дата о действия разрешения на эксплуатацию
        /// </summary>
        [DataMember]
        public DateTime? PermissionCancelDate { get; set; }
        ...
        /// </summary>
        [DataMember]
        public float[] StationTxFreq { get; set; }

        /// <summary>
        /// 
        /// </summary>
        [DataMember]
        public float[] StationRxFreq { get; set; }
